  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">Elephant Population Trend</h2>
        <div className="h-80 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <LineChart
              data={elephantPopulationData}
        ...
        <p className="text-sm text-gray-500 mt-4">
          Source: Estimated global African elephant population trends (simplified for illustration)
        </p>
      </div>
    </div>
  );
